...
class Piece:
    ...
    def set_tiles(self):
        ...
        if self.shape == Shape.TWO:
            self.tiles.append(
                Tile(self.center.get_location()[0] + self.center.get_actual_width(), self.center.get_location()[1],
        ...
        # 3 tiles
            ...
            self.tiles.append(
                Tile(self.center.get_location()[0] + self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   self.center.get_location()[1] + self.center.get_actual_height(),
                                   self.center.get_color()))
            ...
            self.tiles.append(
                Tile(self.center.get_location()[0] + self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
            self.tiles.append(
                Tile(self.center.get_location()[0] + 2 * self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
        # 4 tiles
        elif self.shape == Shape.T4:
            self.tiles.append(
                Tile(self.center.get_location()[0] - 1, self.center.get_location()[1] + self.center.get_actual_height(),
                     self.center.get_color()))
            self.tiles.append(
                Tile(self.center.get_location()[0], self.center.get_location()[1] + self.center.get_actual_height(),
                     self.center.get_color()))
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   self.center.get_location()[1] + self.center.get_actual_height(),
                                   self.center.get_color()))
            ...
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   ...
                                   self.center.get_color()))
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   self.center.get_location()[1] + 2 * self.center.get_actual_height(),
                                   self.center.get_color()))
            ...
            self.tiles.append(
                Tile(self.center.get_location()[0] + 2 * self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
            self.tiles.append(
                Tile(self.center.get_location()[0] + 3 * self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
        ...
        # 5 tiles
            ...
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   self.center.get_location()[1] + self.center.get_actual_height(),
                                   self.center.get_color()))
            self.tiles.append(Tile(self.center.get_location()[0] - 1,
                                   self.center.get_location()[1] + 2 * self.center.get_actual_height(),
                                   self.center.get_color()))
            ...
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   ...
                                   self.center.get_color()))
            self.tiles.append(
                Tile(self.center.get_location()[0], self.center.get_location()[1] + 2 * self.center.get_actual_height(),
                     self.center.get_color()))
            ...
            self.tiles.append(Tile(self.center.get_location()[0] + self.center.get_actual_width(),
                                   self.center.get_location()[1] + 2 * self.center.get_actual_height(),
                                   self.center.get_color()))
            self.tiles.append(Tile(self.center.get_location()[0] + 2 * self.center.get_actual_width(),
                                   self.center.get_location()[1] + 2 * self.center.get_actual_height(),
                                   self.center.get_color()))
            ...
            self.tiles.append(
                Tile(self.center.get_location()[0] + 3 * self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
            self.tiles.append(
                Tile(self.center.get_location()[0] + 4 * self.center.get_actual_width(), self.center.get_location()[1],
                     self.center.get_color()))
...
def create_set(set_color, x, y):
    i = 1
    piece_list = []
    while (i < 22):
        piece_list.append(Piece(Shape(i), Tile(x, y, set_color)))
    return piece_list
